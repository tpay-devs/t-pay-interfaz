...
--    for order_then_pay OR order_and_pay with cash_pos, then add 'item_added' ONLY for order_then_pay.
...
BEGIN
  IF TG_OP = 'INSERT' THEN
    ...
    -- CRITICAL: Only create 'item_added' notifications for order_then_pay mode
    -- For order_and_pay + cash_pos, all items come at once so no need for individual item notifications
