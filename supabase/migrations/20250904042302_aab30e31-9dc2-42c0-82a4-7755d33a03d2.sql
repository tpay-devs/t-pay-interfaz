-- Update create_detailed_order_notification to remove problematic Cash/POS immediate notification logic
...
BEGIN
  ...
  -- NOTE: Removed order_and_pay + cash_pos immediate notification logic to prevent timing issues
  -- These notifications will be created by create_order_item_notification() when items are inserted
