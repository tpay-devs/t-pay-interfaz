-- Fix the notification function to handle null values properly
    ...
    ELSIF operation_mode = 'menu_only' THEN
      IF restaurant_id IS NOT NULL THEN
        ...
        VALUES (
          ...
          'payment_received',
          'Pago Recibido',
          'Mesa ' || COALESCE(table_number::text, '0') || ' pagó – $' || COALESCE(NEW.total_amount::numeric(10,2)::text, '0.00')
        );
      END IF;
    ELSE
      ...
      ELSE
        ...
        IF restaurant_id IS NOT NULL THEN
          ...
          VALUES (
            ...
            'new_order',
            'Nuevo Pedido',
            'Mesa ' || COALESCE(table_number::text, '0') || ' realizó un pedido - Total: $' || COALESCE(NEW.total_amount::numeric(10,2)::text, '0.00')
          );
        END IF;
      END IF;
    END IF;
