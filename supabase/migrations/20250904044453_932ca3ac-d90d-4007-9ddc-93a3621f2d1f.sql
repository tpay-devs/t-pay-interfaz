-- Step 1: Create unique partial indexes to prevent duplicate notifications
...
-- Step 2: Enhanced create_order_item_notification function with advisory locking
...
-- Step 3: Create the missing triggers
...
-- Step 4: Backfill missing notifications for recent cash/pos orders
INSERT INTO public.notifications (restaurant_id, order_id, table_id, type, title, message)
SELECT 
  o.restaurant_id,
  o.id,
